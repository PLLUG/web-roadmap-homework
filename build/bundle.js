...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getIterator = __webpack_require__(70)['default'];

	var _interopRequireDefault = __webpack_require__(73)['default'];

	var _Employee = __webpack_require__(74);

	var _Employee2 = _interopRequireDefault(_Employee);

	var _Department = __webpack_require__(75);

	var _Department2 = _interopRequireDefault(_Department);

	var department = new _Department2['default'](name = "Pllug");
	var employee = new _Employee2['default']("First", "Last", 32, "Developer", 1000);
	...
	try {
	  for (var _iterator = _getIterator(department.employeesList()), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	    var _employee = _step.value;

	    console.log(_employee.first + ' | ' + _employee.last + ' | ' + _employee.job + ' | ' + _employee.totalCalary() + '$');
	  }
	} catch (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCE){
	  ...
	  if(_native){
	    ...
	    __webpack_require__(18)(IteratorPrototype, TAG, true);
	    // FF fix
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(Constructor, NAME, next){
	  ...
	  __webpack_require__(18)(Constructor, NAME + ' Iterator');
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var setUnscope = __webpack_require__(42)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Person2 = __webpack_require__(86);
	...
	var Employee = (function (_Person) {
	  ...
	  function Employee(first, last, age, job, salary) {
	    _classCallCheck(this, Employee);

	    _get(Object.getPrototypeOf(Employee.prototype), 'constructor', this).call(this, first, last, age);
	    this.job = job;
	    this.bonus = 0;
	    this.salary = salary;
	  }
	  ...
	  _createClass(Employee, [{
	    key: 'addBonus',
	    value: function addBonus(bonus) {
	      this.bonus = bonus;
	    }
	  }, {
	    key: 'totalCalary',
	    value: function totalCalary() {
